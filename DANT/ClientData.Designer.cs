...
namespace DANT {
    ...
    public partial class ClientData : global::System.Data.DataSet {
        ...
        public partial class ClientDataTable : global::System.Data.TypedTableBase<ClientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ClientRow AddClientRow(int card_number, string phone, string email, string fio) {
        ...
        public partial class ClientRow : global::System.Data.DataRow {
            ...
            public int card_number {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'card_number\' в таблице \'Client\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public bool Iscard_numberNull() {
                return this.IsNull(this.tableClient.card_numberColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void Setcard_numberNull() {
                this[this.tableClient.card_numberColumn] = global::System.Convert.DBNull;
            }
...
namespace DANT.ClientDataTableAdapters {
    ...
    public partial class ClientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Client] WHERE (((@IsNull_card_number = 1 AND [card_number] IS NULL) OR ([card_number] = @Original_card_number)) AND ([phone] = @Original_phone) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ([id] = @Original_id))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Client] SET [card_number] = @card_number, [phone] = @phone, [email] = @email WHERE (((@IsNull_card_number = 1 AND [card_number] IS NULL) OR ([card_number] = @Original_card_number)) AND ([phone] = @Original_phone) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ([id] = @Original_id));
SELECT card_number, name + ' ' + surname + ' ' + patronymic AS fio, phone, email, id FROM Client WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT card_number, Client.name + \' \' + Client.surname + \' \' + Client.patronymic " +
                "AS fio, phone, email, id FROM Client";
        ...
        public virtual int Delete(global::System.Nullable<int> Original_card_number, string Original_phone, string Original_email, int Original_id) {
            if ((Original_card_number.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[0].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_card_number.Value));
            }
            else {
        ...
        public virtual int Update(global::System.Nullable<int> card_number, string phone, string email, global::System.Nullable<int> Original_card_number, string Original_phone, string Original_email, int Original_id, int id) {
            if ((card_number.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(card_number.Value));
            }
            else {
            ...
            if ((Original_card_number.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_card_number.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> card_number, string phone, string email, global::System.Nullable<int> Original_card_number, string Original_phone, string Original_email, int Original_id) {
            return this.Update(card_number, phone, email, Original_card_number, Original_phone, Original_email, Original_id, Original_id);
        }
    }
